...
<ul>
    ...
    <li>![image](https://github.com/jkaiser87/VOL3D/blob/master/Fiji.app/macros/toolsets/icons/folder.png) <b>Select the appropriate folder:</b> Choose the folder that contains either whole-slide overview TIF files or single-slice separate-channel TIF files. If the correct filename convention is followed, the folder can contain multiple animals' data within the same folder.</li>
